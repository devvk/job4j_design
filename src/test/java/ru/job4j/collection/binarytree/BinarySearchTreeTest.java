...
class BinarySearchTreeTest {
    ...
    void whenAddToEmptyTreeThenListContainsOneElement() {
        ...
        assertThat(tree.inSymmetricalOrder()).hasSize(1).containsExactly("first");
    }
    ...
    void whenAddTwoToEmptyTreeThenListContainsTwoElement() {
        ...
        assertThat(tree.inSymmetricalOrder()).hasSize(2).containsExactly("first", "second");
    }
    ...
    void whenSymmetricalOrderThenOk() {
        ...
        assertThat(tree.inSymmetricalOrder()).hasSize(7).containsExactly(1, 2, 3, 4, 5, 6, 7);
    }
    ...
    void whenPreOrderThenOk() {
        ...
        assertThat(tree.inPreOrder()).hasSize(7).containsExactly(4, 2, 1, 3, 6, 5, 7);
    }
    ...
    void whenPostOrderThenOk() {
        ...
        assertThat(tree.inPostOrder()).hasSize(7).containsExactly(1, 3, 2, 5, 7, 6, 4);
    }

    @Test
    void whenClearThenTreeBecomesEmptyAndCanBeUsedAgain() {
        BinarySearchTree<Integer> tree = new BinarySearchTree<>();
        for (int element : new int[]{4, 2, 6, 3, 5, 7, 1}) {
            tree.put(element);
        }
